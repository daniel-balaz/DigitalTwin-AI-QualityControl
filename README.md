...
* [cite_start]**Pokročilý Scoring:** Algoritmus vyhodnocující "zdraví" stroje na základě aktuální a průměrné teploty[cite: 1].
...
* [cite_start]`logic_modul.py`: Rozhodovací logika a bodový systém[cite: 1].
